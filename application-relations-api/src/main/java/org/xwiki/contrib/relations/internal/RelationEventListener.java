 ...
 */
@Component
@Named(RelationEventListener.LISTENER_NAME)
@Singleton
public class RelationEventListener extends AbstractEventListener
{
    /**
    ...
    @Inject
    protected RelationQueryExecutor pageRelations;
        ...
        DocumentReference newComplement) throws XWikiException
    {
        ...
        BaseObject relationObject =
            relatedPage.getXObject(RelationQueryExecutor.IS_RELATED_TO_CLASS_REFERENCE,
                RelationQueryExecutor.PAGE_FIELD, relationObjectValue, false);
        if (relationObject != null) {
            ...
            relationObject.setStringValue(RelationQueryExecutor.PAGE_FIELD, newRelationObjectValue);
