 ...
 */
@Component
@Named(RelationsEventListener.LISTENER_NAME)
@Singleton
public class RelationsEventListener extends AbstractEventListener
{
    /**
     * The name of the event listener.
     */
    public static final String LISTENER_NAME = "relations.listener";
    ...
    @Inject
    protected RelationsQueryExecutor pageRelations;
        ...
        DocumentReference newComplement) throws XWikiException
    {
        ...
        BaseObject relationObject =
            relatedPage.getXObject(RelationsQueryExecutor.IS_RELATED_TO_CLASS_REFERENCE,
                RelationsQueryExecutor.PAGE_FIELD, relationObjectValue, false);
        if (relationObject != null) {
            ...
            relationObject.setStringValue(RelationsQueryExecutor.PAGE_FIELD, newRelationObjectValue);
            String newPageId = defaultSerializer.serialize(newComplement);
            String message = contextLocalization.getTranslationPlain("relations.update.page", newPageId);
        ...
        throws XWikiException
    {
        ...
        if (relationObject != null) {
            ...
            String message = contextLocalization.getTranslationPlain("relations.remove.page", subject);
