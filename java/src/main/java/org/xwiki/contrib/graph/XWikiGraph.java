...
{
    void addEdge(DocumentReference origin, DocumentReference relation, Object target)
            throws GraphException;

    void addEdgeOnce(DocumentReference origin, DocumentReference relation, Object target)
            throws GraphException;
